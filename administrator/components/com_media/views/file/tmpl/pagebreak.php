...
<div class="container-popup">
	<form class="form-horizontal">
		...
		<div class="control-group">
			<label for="title" class="control-label"><?php echo JText::_('COM_MEDIA_PAGEBREAK_TITLE'); ?></label>
			<div class="controls"><input type="text" id="title" name="title" /></div>
		</div>

		<div class="control-group">
			<label for="alias" class="control-label"><?php echo JText::_('COM_MEDIA_PAGEBREAK_TOC'); ?></label>
			<div class="controls"><input type="text" id="alt" name="alt" /></div>
		</div>

		<button onclick="insertPagebreak();" class="btn btn-primary"><?php echo JText::_('COM_MEDIA_PAGEBREAK_INSERT_BUTTON'); ?></button>
