...
class MediaViewFiles extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		{
			// In file associations modal we need to remove language filter if forcing a language.
	...
	{
		$canDo = MediaHelper::getActions('com_media', 'category', $this->state->get('filter.category_id'));
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			JToolbarHelper::custom('files.featured', 'featured.png', 'featured_f2.png', 'JFEATURE', true);
			JToolbarHelper::custom('files.unfeatured', 'unfeatured.png', 'featured_f2.png', 'JUNFEATURE', true);
		...
		{
			JToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'files.delete', 'JTOOLBAR_EMPTY_TRASH');
		}
