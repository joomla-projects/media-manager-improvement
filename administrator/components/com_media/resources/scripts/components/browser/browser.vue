    ...
    export default {
        ...
        methods: {
            ...
            unselectAllBrowserItems(event) {
                const eventOutside = (this.$refs.browserItems && !this.$refs.browserItems.contains(event.target)) && event.path.indexOf(this.$parent.$refs.infobar.$el) < 0 || event.target === this.$refs.browserItems;
                if (eventOutside) {
